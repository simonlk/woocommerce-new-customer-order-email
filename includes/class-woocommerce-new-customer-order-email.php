 ...
 * @extends WC_Email
 */
class WC_New_Customer_Order_Email extends WC_Email {

	/**
	 * Constructor
	 */
	function __construct() {
		$this->id 				= 'new_customer_order';
		$this->title 			= __( 'New order - customer', 'woocommerce' );
		$this->description		= __( 'New customer order is sent when the order is processing or completed. This email is to replace the default "Order Processing" and "Order Complete".', 'woocommerce' );
